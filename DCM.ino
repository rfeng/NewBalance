...
{
  Gyro_Vector[0]=gyro_x;  //Gyro_Scaled_X(gyro_x); //gyro x roll
  Gyro_Vector[1]=gyro_y;  //Gyro_Scaled_Y(gyro_y); //gyro y pitch
  Gyro_Vector[2]=gyro_z;  //Gyro_Scaled_Z(gyro_z); //gyro Z yaw
